        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs opacity-90">Session ID: {params.sessionId}</p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {messages.map((msg) => (
              <div
                key={msg.id}
                className={`flex ${
                  msg.is_counsellor ? "justify-end" : "justify-start"
                }`}
              >
      ...
      <div className="bg-white shadow-md p-4 border-t border-gray-200">
        ...
        >
          ...
          <button
            ...
            className={`p-3 rounded-l-lg border border-gray-300 bg-gray-50 flex items-center justify-center ${
              isSessionEnded ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-100"
            }`}
          >
          ...
          <button
            ...
            className={`bg-[#642494] text-white p-3 rounded-r-lg flex items-center justify-center ${
              sendingMessage || (!newMessage.trim() && !selectedFile) || isSessionEnded
